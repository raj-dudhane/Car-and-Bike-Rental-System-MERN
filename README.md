...
* **Browse Vehicles:** View available cars and bikes with pricing details.
* **Booking System:** Select start/end dates and book vehicles instantly.
...
* **Delete Vehicles:** Permanently remove vehicles from the fleet.
* **Master View:** View a table of ALL bookings made by any user.
